...
public class Main { // Client class
    ...
    public static void main(String[] args) {
        ...
        // LocalDate.parse is needed in order to call our LocalDate from Task_1.Perishable. String format isnt enough.
        // Task_1.Perishable
        ...
        System.out.println(product3); // Calls the Overriden toString method in Task_1.Perishable.java
        ...
        if(product3 instanceof Perishable){
            ...
            System.out.println("\nDate now is: " + p.dateNow + " | Task_1.Product expires: " + p.bestBefore + ".. | Is the date after best before? " + p.isAfterBestBefore());

        } // Downcasting our Task_1.Perishable in order to print out the true/false method
